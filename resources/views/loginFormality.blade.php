...
<div class="container col">
    <div class="shadow-lg p-3 mb-5 bg-white rounded col-md-4 align-items-center container-sm vw-50 container-fluid  mt-5 d-flex justify-content-center "
        style="width: 250px;">
        <form method="post" action="{{route('auth.process')}}" value="{{csrf_token()}} " style="width:">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="container-sm">
                <form method="post" action="{{route('auth.process')}}" style="width:300">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 form-group col-md-6">
                            <input type="text" class="form-control" aria-describedby="" name="lastname"
                    ...
                    <div class="row">
                        <div class="mb-3 form-group col-md-6">
                            <input type="date" class="form-control" aria-describedby="" name="birthdate"
                                placeholder="Birthdate">
                        </div>
                        <div class="mb-3 form-group col-md-6">
                            <input type="text" class="form-control" aria-describedby="" name="country"
                                placeholder="Country">
                        </div>
                    </div>
                    <!---->
                    <div class="row">
                        <div class="form-group mb-3 col-md-6">
                            <input type="text" class="form-control" aria-describedby="" name="nationality"
                                placeholder="Nationality">
                        </div>
                        <div class="form-group mb-3 col-md-6">
                            <input type="text" class="form-control" aria-describedby="" name="state"
